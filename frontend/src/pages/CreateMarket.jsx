...
const styles = {
  ...
  card: { background: '#fff', borderRadius: '8px', padding: '2rem', boxShadow: '0 1px 4px rgba(0,0,0,0.08)' },
  ...
  outcomeInput: { flex: 2, padding: '0.5rem', border: '1px solid #ccc', borderRadius: '4px', fontSize: '0.95rem' },
  probInput: { flex: 1, padding: '0.5rem', border: '1px solid #ccc', borderRadius: '4px', fontSize: '0.95rem' },
  removeBtn: { background: '#fee2e2', color: '#b91c1c', border: 'none', borderRadius: '4px', padding: '0.4rem 0.7rem', cursor: 'pointer', fontWeight: '600' },
      ...
      <div style={styles.main}>
        ...
        <div style={styles.card}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input style={styles.input} type="datetime-local" value={endTime} onChange={e => setEndTime(e.target.value)} required />
